	...
	ConROC_RotationSettingsTable = {
	 {
	    ...
	    spells = {
	      ...
	      {spellID = "None", spellCheckbox = "Sting_None", reqLevel = 4, type="spell"}
	    },
	  ...
	  },
	  {
	    frameName = "Options",
	    spells = {
		    {spellID = ids.optionMaxIds.ExplosiveTrap, spellCheckbox = "Option_ExpTrapWeaving", reqLevel = 34, type="custom", icon=237511, customName="Use Explosive Trap Weaving"},
